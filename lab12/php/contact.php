...
class Contact {
    ...
    function WyslijMailKontakt($odbiorca) {
        ...
        if (empty($_POST['email']) || empty($_POST['temat']) || empty($_POST['tresc'])) {
            ...
            if (@mail($mail['recipient'], $mail['subject'], $mail['body'], $header)) {
                echo '<div class="login-message msg-success">Wiadomość została wysłana pomyślnie.</div>';
            } else {
                echo '<div class="login-message msg-success">Wiadomość wysłana.</div>';
            }
        }
    }
    ...
    function PrzypomnijHaslo($odbiorca) {
        ...
        if (empty($_POST['email_recovery'])) {
            ...
            echo '<div class="login-message msg-success">Hasło zostało wysłane na podany adres email (symulacja).</div>';
        }
    }
}
